              ...
              <form role="form" class="form-horizontal of" action="ServletCadastroPessoa" method="post">
                ...
                <div class="card card-outline card-secondary">                	
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="logradouro" class="form-control" id="inputEmail3" required="required" placeholder="Rua, Avenida, Travessa, Praça">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="numero" class="form-control" id="inputEmail3" required="required" placeholder="Número">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="cep" class="form-control" id="inputEmail3" required="required" placeholder="Nº de CEP">
                    </div>
                  </div>
